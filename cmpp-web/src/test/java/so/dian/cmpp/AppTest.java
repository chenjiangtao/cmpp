...
public class AppTest  extends TestCase
{
	...
	public void test7() {
     ...
     public void test8() {
    	 String msgContent="{\"protocol\":5,\"t\":1513081814,\"data\":{\"devId\":\"7706477739\",\"dps\":{\"1\":false,\"6\":60}},\"sequenceId\":2}";
    	 String context=msgContent.replaceAll("\\{", "\\(").replaceAll("\\}", "\\)");
   ...
   // 	 System.out.println(s);
     ...
     public void test9() {
    	 ...
    	 String s=encoder.encode(msgContent.getBytes()).replaceAll("\n", "");
    	 System.out.println(s);
     ...
     public void test10() {
    	 ...
    	 System.out.println("一共消耗 "+(System.currentTimeMillis()-current));
